...
<div class="results">
	...
	<ol class="list<?php echo $this->params->get('pageclass_sfx') ?>" start="<?php echo  $start ?>">
		...
		<li>
			<?php if ($result->href) : //link muss noch mit layout=oxevent angepasst werden?>
			...
			<?php echo JText::_('Category') ?>:
				<span class="small<?php echo $this->params->get('pageclass_sfx') ?>">
					<?php
						$sectiontext =  $this->escape($result->section);
						$sectiontext = str_replace('Programm/Programm', 'Programm', $sectiontext);
						$sectiontext = str_replace('Phocagallery /', 'Galerie /', $sectiontext);
