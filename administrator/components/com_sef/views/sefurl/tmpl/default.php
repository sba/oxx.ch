...
?>
	...
	function submitbutton(pressbutton)
	{
	    ...
	    if (form.newurl.value == "") {
	        ...
	        if (form.newurl.value.match(/^index.php/)) {
	            ...
	            if( (form.oldurl.value != form.unchanged.value) && (form.id.value != "0" && form.id.value != "") ) {
	                <?php if( $sefConfig->useMovedAsk ) { ?>
	                if( !confirm("<?php echo JText::_(_COM_SEF_CONFIRM301); ?>") ) {
	...
	<table class="adminform">
		...
		<tr>
			...
			<td><input class="inputbox" type="text" size="100" name="oldurl" value="<?php echo $this->sef->oldurl; ?>">
			<?php echo JHTML::_('tooltip', JText::_('Only relative redirection from the Joomla/Mambo root <i>without</i> the leading slash')); ?>
			</td>
		</tr>
		<tr>
			<td><?php echo JText::_('Old Non-SEF Url');?></td>
			<td align="left"><input class="inputbox" type="text" size="100" name="newurl" value="<?php echo $this->sef->newurl; ?>">
			<?php echo JHTML::_('tooltip', JText::_('This URL must begin with index.php'));?>
			</td>
		</tr>
		<tr>
			...
			<?php echo JHTML::_('tooltip', JText::_('Menu item associated with this URL.'));?>
			</td>
		</tr>		
		<tr>
  		<td></td>
		...
		<tr><th colspan="2"><?php echo JText::_('Meta Tags (optional)'); ?></th></tr>
		<tr><td colspan="2"><?php echo  JHTML::_('tooltip', JText::_('JoomSEF MetaBot Notice')).' '.JText::_(_COM_SEF_META_INFO); ?></td></tr>
		<tr>
...
<input type="hidden" name="unchanged" value="<?php echo $this->sef->oldurl; ?>" />
