...
$query = 'SELECT a.id, a.sectionid, a.title, a.created, a.modified, u.name, a.created_by_alias, a.created_by, SUBSTRING(a.attribs, 12,10) as event_date'
. ' FROM #__content AS a'
...
<tr>
	...
	<td class="title">
		<strong>Anlass-Datum</strong>
	</td>
	<?php /*
	<td class="title">
		<strong><?php echo JText::_( 'Erstellt am' ); ?></strong>
	</td>
	*/?>
	<td class="title">
...
if (count( $rows ))
{
	foreach ($rows as $row)
	{
		...
		<tr>
			...
			<td>
				<?php echo JHTML::_('date', $row->event_date, '%d.%m.%Y'); ?>
			</td>
<?php /*
			<td>
