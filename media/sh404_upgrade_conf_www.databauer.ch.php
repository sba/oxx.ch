...
// saved at: 2008-08-06 09:14:45
// by: stefan (id: 63 )
// domain: http://www.databauer.ch
...
$skip = array("easybook");
$nocache = array();
$shDoNotOverrideOwnSef = array("easybook");
$shLog404Errors = "1";
$shUseURLCache = "1";
$shMaxURLInCache = "10000";
$shTranslateURL = "1";
$shInsertLanguageCode = "1";
$notTranslateURLList = array("easybook");
...
$shInsertNumericalIdCatList = array("1","3","28","27","31","32","29","25","30");
...
$shLangTranslateList = array("german"=>"0","english"=>"0");
$shLangInsertCodeList = array("german"=>"0","english"=>"0");
$defaultComponentStringList = array("contact"=>"","content"=>"","easybook"=>"","jce"=>"","newsfeeds"=>"","phocagallery"=>"","poll"=>"","search"=>"","user"=>"","weblinks"=>"","wrapper"=>"");
$pageTexts = array("german"=>"Page-%s","english"=>"Page-%s");
...
$fileAccessStatus = array(" <strong style=\"color:green\">beschreibbar</strong>"," <strong style=\"color:green\">beschreibbar</strong>"," <strong style=\"color:green\">beschreibbar</strong>"," <strong style=\"color:green\">beschreibbar</strong>"," <strong style=\"color:green\">beschreibbar</strong>");
?>